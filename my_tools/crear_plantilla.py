...
def create_template(Nombre_Tecnico, ID_Feeder, Tipo_Feeder, Fecha_Mantenimiento, Color_Semana,Observaciones):
    ...
    parametros:
        ...
        -Color de semana
    '''
    nombre_excel = r'C:\Users\CECHEVARRIAMENDOZA\OneDrive - Brunswick Corporation\Documents\Proyectos_Python\PysimpleGUI\Proyectos\mantto_feeder\data\MF-64_plantilla.xlsx'
    ...
    nuevo_nombre = f"mantto_feeder\data\MF-{ID_feeder}_{Fecha_Mantenimiento.replace('/','_')}.xlsx"
